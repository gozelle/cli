...
[![GoDoc](https://godoc.org/github.com/urfave/cli?status.svg)](https://pkg.go.dev/github.com/gozelle/cli/v2)
...
```
$ go get github.com/gozelle/cli/v2
```

```go
...
import (
  "github.com/gozelle/cli/v2" // imports as package "cli"
)
...
```
